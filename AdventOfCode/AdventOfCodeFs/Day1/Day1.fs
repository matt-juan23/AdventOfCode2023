...
let filename = @"C:\Dev\AdventOfCode2023\AdventOfCode\AdventOfCode\Day1\TestInput.txt";
...
let solvePart1 = File.ReadLines(filename) |> Seq.map findNumbers |> Seq.sum;

let solvePart2 = File.ReadLines(filename) |> Seq.map findNumbers2 |> Seq.sum;
